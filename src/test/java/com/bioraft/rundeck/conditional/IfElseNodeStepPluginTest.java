...
public class IfElseNodeStepPluginTest {

	IfElseNodeStepPlugin plugin;
	...
	@Test
	public void runTrueTests() throws NodeStepException {
		int i = 0;
	...
	@Test
	public void runFalseTests() throws NodeStepException {
		int i = 0;
	...
	private void runTestTrue(String testValue, String operator, String comparison, int calls) throws NodeStepException {
		String group = "raft";
		String name = "test";
		String ifTrue = "1";
		String ifFalse = "0";
		...
		this.plugin.executeNodeStep(context, configuration, null);
